...
# Multiple files
files = [
    ("files", open(r"C:\Users\HP\Downloads\Sample Salary Slip2.pdf", "rb")),
    ("files", open(r"C:\Users\HP\Downloads\Sample Salary Slip2.png", "rb")),
    ("files", open(r"C:\Users\HP\Documents\Sample Salary Slip3.xlsx", "rb"))
]
